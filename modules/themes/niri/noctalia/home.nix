    ...
    lib.mkIf enabled
    {
      home.packages = [
        (pkgs.writeShellScriptBin
          "noctalia-diff"
          ''
            ${pkgs.delta}/bin/delta <(${pkgs.jq}/bin/jq -S .settings ${config.home.homeDirectory}/.config/noctalia/settings.json) <(${pkgs.wl-clipboard}/bin/wl-paste | ${pkgs.jq}/bin/jq -S .)
          '')
      ];
        ...
        settings = {
          settings = {
            ...
            wallpaper = {
              ...
              directory = "/home/fabibo/Pictures/Wallpapers"; # Check this path!
              monitorDirectories = [];
